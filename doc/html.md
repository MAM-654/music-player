...
* [`index.html`](#indexhtml) - a default HTML skeconston that should form the
...
The charset declaration (`<meta charset="utf-8">`) must be included compconstely
...
Media Queries - The Compconste Idiot's Guide"). You can find out more in [the MDN
Web
...
contains a very skeconstal "app" definition, just to show the basic usage. You
